...
const adminCards = [
  { title: "Service Requests", text: "Review contact forms and quick quote requests.", to: "/admin/requests", cta: "Open Requests" },
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 grid gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div>
            ...
            <h1 className="mt-2 text-4xl font-extrabold">BPJ Site Operations</h1>
            <p className="mt-3 max-w-3xl text-gray-300">
              Manage customer requests, quotes, orders, users, home page blog posts, and testimonials from one polished control area.
            </p>
          </div>
          <div className="rounded-lg border border-amber-400/30 bg-amber-400/10 p-5">
            <h2 className="font-bold text-amber-100">Demo customer test kit</h2>
            <p className="mt-2 text-sm text-amber-50/80">
              Creates a customer login, quote, paid order, service request, blog posts, and testimonials for live testing.
            </p>
            <button
              onClick={seedDemo}
              disabled={seeding}
